...
export default function LessonDetail() {
  ...
  const QuizCard = ({ qz, accent = "#0066FF" }) => (
    <div className="rounded-md border p-4" style={{ borderColor: `${accent}40`, background: `${accent}0D` }} data-testid={`quiz-for-${qz.block_id}`}>
      <div className="mb-3 flex items-center gap-2 text-[10px] uppercase tracking-[0.2em]" style={{ color: accent }}><HelpCircle className="h-3.5 w-3.5" /> {qz.block_id === "theory" ? "Theory" : "Practice"} Quiz</div>
