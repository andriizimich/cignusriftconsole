...
async def seed():
    ...
    if await db.lessons.count_documents({}) == 0:
        lessons = [
            {"id": "L-001", "title": "MetaHuman Interview Simulation", "category": "Psychology", "duration": 40, "theory_ids": ["CT-004", "CT-008"], "practice_ids": ["CP-002"], "quizzes": [{"id": "Q1", "block_id": "theory", "question": "What signals build rapport fastest?", "options": ["Eye contact", "Silence", "Interrupting", "Note-taking"], "correct": 0}, {"id": "Q2", "block_id": "practice", "question": "A strong interview opens with?", "options": ["A hook", "Pricing", "Silence", "Legal"], "correct": 0}]},
            {"id": "L-002", "title": "Lumen Lighting Theory + Practice", "category": "Computer Science", "duration": 30, "theory_ids": ["CT-002"], "practice_ids": ["CP-001"], "quizzes": [{"id": "Q1", "block_id": "theory", "question": "Lumen provides?", "options": ["Global illumination", "Physics", "Audio", "Networking"], "correct": 0}]},
            {"id": "L-003", "title": "Enterprise Consulting Simulation", "category": "Finance", "duration": 40, "theory_ids": ["CT-006"], "practice_ids": ["CP-004", "CP-008"], "quizzes": [{"id": "Q1", "block_id": "practice", "question": "A good pitch opens with?", "options": ["The ask", "A hook", "Pricing", "Legal"], "correct": 1}]},
            {"id": "L-004", "title": "Crisis Response Scenario", "category": "Law Enforcement", "duration": 35, "theory_ids": ["CT-006", "CT-007"], "practice_ids": ["CP-005"], "quizzes": [{"id": "Q1", "block_id": "theory", "question": "First step in a crisis?", "options": ["Assess", "Panic", "Delegate blame", "Wait"], "correct": 0}]},
            {"id": "L-005", "title": "Nanite Environment Walkthrough", "category": "Architecture", "duration": 30, "theory_ids": ["CT-001", "CT-003"], "practice_ids": ["CP-003"], "quizzes": [{"id": "Q1", "block_id": "practice", "question": "Nanite optimizes?", "options": ["Geometry", "Sound", "AI", "Text"], "correct": 0}]},
            {"id": "L-006", "title": "Field Safety Simulation", "category": "Corporate Safety", "duration": 25, "theory_ids": ["CT-007"], "practice_ids": ["CP-007"], "quizzes": [{"id": "Q1", "block_id": "theory", "question": "PPE stands for?", "options": ["Personal Protective Equipment", "Public Policy Exam", "Peak Performance Effort", "None"], "correct": 0}]},
        ]
        for l in lessons:
